...
/**
 * @brief Finds duplicate in an array.
 * @param arr The array which will be compared with the number.
 * @param num The number of elements in an array.
 * @return int Returns the duplicates in the array.
 */
